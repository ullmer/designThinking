...
int TclMoveNObj(ClientData , Tcl_Interp *interp, int argc, char *argv[]); 
int TclMoveTo(ClientData , Tcl_Interp *interp, int argc, char *argv[]); 

int TclShiftNObj(ClientData , Tcl_Interp *interp, int argc, char *argv[]); 
int TclShiftTo(ClientData , Tcl_Interp *interp, int argc, char *argv[]); 
