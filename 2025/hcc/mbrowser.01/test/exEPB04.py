...
epb1 = EnoPrismBars(flowLeft=False, textOffset2=(-25,0))
epb1.addBar("22: Daejeon",  cyel, 50)
epb1.addBar("23: Warsaw",   cblu, 50)
epb1.addBar("24: Cork",     cblu, 400)
epb1.addBar("25: Bordeaux", cblu, 50)
epb1.addBar("26: Chicago",  cred, 50)

epb2 = EnoPrismBars(flowLeft=True, textOffset2=(650, 0))
